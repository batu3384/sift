...
require_file "$MANIFEST_DIR/winget/batuhanyuksel.SIFT.yaml"
require_file "$MANIFEST_DIR/winget/batuhanyuksel.SIFT.locale.en-US.yaml"
require_file "$MANIFEST_DIR/winget/batuhanyuksel.SIFT.installer.yaml"
...
grep -q "PackageVersion: ${SHORT_VERSION}" "$MANIFEST_DIR/winget/batuhanyuksel.SIFT.yaml"
