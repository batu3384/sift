...
// CloudOfficeCategoryRules returns rules for Cloud & Office category
func CloudOfficeCategoryRules() []Definition {
	return []Definition{
		{
			ID:          "cloud_office",
			Name:        "Cloud & Office",
...
// VirtualizationCategoryRules returns rules for Virtualization category
func VirtualizationCategoryRules() []Definition {
	return []Definition{
		{
			ID:          "virtualization",
			Name:        "Virtualization",
...
// DeviceBackupsCategoryRules returns rules for Device Backups category
func DeviceBackupsCategoryRules() []Definition {
	return []Definition{
		{
			ID:          "device_backups",
			Name:        "Device Backups",
...
// TimeMachineCategoryRules returns rules for Time Machine category
func TimeMachineCategoryRules() []Definition {
	return []Definition{
		{
			ID:          "time_machine",
			Name:        "Time Machine",
